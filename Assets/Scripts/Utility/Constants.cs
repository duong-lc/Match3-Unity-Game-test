public class Constants 
{
    ...
    public const string SPRITE_FISH_TYPE_ONE = "Fish/fish_1";

    public const string SPRITE_FISH_TYPE_TWO = "Fish/fish_2";

    public const string SPRITE_FISH_TYPE_THREE = "Fish/fish_3";

    public const string SPRITE_FISH_TYPE_FOUR = "Fish/fish_4";
